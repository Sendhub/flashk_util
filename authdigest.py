...
class RealmDigestDb(object):
    ...
    :param algorthm: string identifying hash algorithm to use, default is 'md5'.
    """
    ...
    def __setitem__(self, user, password):
        return self.addUser(user, password)
...
class AuthenticationResult(object):
    ...
    Created by RealmDigestDb.isAuthenticated to operate as a boolean result, and storage of authentication information.
    """
    authenticated = None
    reason = None
    status = 500
